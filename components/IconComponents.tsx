...
export const SocaLogoIcon: React.FC<{ className?: string }> = ({ className = 'w-10 h-10' }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <defs>
            <linearGradient id="soca-gradient" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#00A9A5"/>
                <stop offset="100%" stopColor="#4ECCA3"/>
            </linearGradient>
        </defs>
        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="url(#soca-gradient)" strokeWidth="1.5" className="transition-transform duration-500 ease-out group-hover:rotate-180"/>
        <path d="M10.6895 7.23001C10.6895 7.23001 13.5995 7.23001 14.2895 7.92001C14.9795 8.61001 13.5995 9.30001 13.5995 10C13.5995 10.7 15.3295 11.04 15.3295 12C15.3295 12.96 13.5995 14.04 13.5995 14.73C13.5995 15.42 14.6395 16.11 13.5995 16.8C12.5595 17.49 9.64952 16.8 9.64952 16.8" stroke="url(#soca-gradient)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="transition-all duration-500 ease-out group-hover:stroke-width-2 group-hover:opacity-80"/>
    </svg>
);
...
export const SwordsIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14.5 17.5 3 6"/><path d="m21 3-9 9"/><path d="M9.5 17.5 3 11"/><path d="m15 3-6 6"/><path d="M3 21h18"/>
    </svg>
);
